...
<title>Employee Dashboard - TaskWave</title>
<link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
<style>
body{font-family:'Roboto',sans-serif;background:#f0f2f5;margin:0;padding:0;}
.container{max-width:1000px;margin:20px auto;padding:20px;}
header{display:flex;justify-content:space-between;align-items:center;background:#2196F3;color:white;padding:15px 20px;border-radius:8px;}
header h1{margin:0;}
header button{background:#FF5252;border:none;padding:10px 15px;border-radius:6px;cursor:pointer;color:white;font-weight:500;}
...
button.action-btn{background:#4CAF50;color:white;border:none;padding:6px 10px;border-radius:5px;cursor:pointer;margin-right:5px;}
</style>
</head>
<body>
<div class="container">
    ...
    <section>
        <h2>Your Tasks</h2>
        <table>
            <tr><th>Title</th><th>Description</th><th>Manager</th><th>Deadline</th><th>Status</th><th>Actions</th></tr>
...
<script>
function updateStatus(taskId){ alert("Update status for task ID: "+taskId); }
</script>
</body>
</html>